...
$mrbs_admin = "Caleb Mah";
$mrbs_admin_email = "cmah001@e.ntu.edu.sg";
$mrbs_company = "North Hill";   // This line must always be uncommented ($mrbs_company is used in various places)
